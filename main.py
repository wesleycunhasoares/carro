...
def on_on_overlap(sprite, otherSprite):
    ...
    if info.score() == 10:
        game.game_over(True)
    mySprite.set_position(randint(0, 150), 102)
    sprites.destroy(mySprite)
sprites.on_overlap(SpriteKind.player, SpriteKind.enemy, on_on_overlap)

mySprite: Sprite = None
game.show_long_text("uma farses foi colocada aki", DialogLayout.BOTTOM)
...
cavaleiro = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
controller.move_sprite(cavaleiro)
cavaleiro.set_position(14, 89)
mySprite = sprites.create(img("""
        ........................
            ........................
            ........................
    ...
    """),
    SpriteKind.enemy)
mySprite.set_position(38, 95)
pirnsessa = sprites.create(img("""
        . . . . . . 5 . 5 . . . . . . . 
            . . . . . f 5 5 5 f f . . . . . 
            . . . . f 1 5 2 5 1 6 f . . . . 
            . . . f 1 6 6 6 6 6 1 6 f . . . 
